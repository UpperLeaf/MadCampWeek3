...
public class BossMain : MonoBehaviour
{
	...
	// === 캐쉬 ==========================================
	protected BossController enemyCtrl;
	...
	{
		enemyCtrl = GetComponent<BossController>();
	...
	{
		// 상태 검사
		AnimatorStateInfo stateInfo = enemyCtrl.anim.GetCurrentAnimatorStateInfo(0);

		if (stateInfo.IsName("IsStop"))
        {
			return false;
        }
		return true;
		...
		if (stateInfo.tagHash == BossController.ANITAG_ATTACK ||
			stateInfo.nameHash == BossController.ANISTS_DMG_A ||
			stateInfo.nameHash == BossController.ANISTS_DMG_B ||
			stateInfo.nameHash == BossController.ANISTS_Dead)
		{
			return false;
		}
